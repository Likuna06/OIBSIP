...
public class TrainReservationSystem {
    ...
    static void connectDB() {
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost/train_reservation", "root", "sl25206");
        } catch (Exception e) {
...
//LOGIN FORM
    static void showLogin() {
        ...
        // Add wrapper to frame to center the content
...
//RESERVATION FORM
    static void showReservation(String user) {
        ...
        panel.add(new JLabel("Fare (INR):"));
        panel.add(priceField);
        panel.add(new JLabel("Total Fare (1 seat):"));
...
//CANCEL FORM
    ...
    static JFrame createFrame(String title) {
        ...
        f.getContentPane().setBackground(new Color(230, 245, 255));
