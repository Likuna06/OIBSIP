...
public class OnlineExamSystem extends JFrame implements ActionListener {
    ...
    // Color scheme
    Color LIGHT_PURPLE = Color.decode("#C7A4E0");
    ...
    void initDB() {
        try {
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/OnlineExamDB", "root", "sl25206");
...
//User authentication
    void initLoginPanel() {
        ...
        loginPanel.setBackground(LIGHT_PURPLE);
    ...
    void initProfilePanel() {
        ...
        profilePanel.setBackground(LIGHT_PURPLE);
    ...
    void initQuizPanel() {
        ...
        quizPanel.setBackground(LIGHT_PURPLE);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            radioButton[i].setBackground(LIGHT_PURPLE);
            radioButton[i].setForeground(WHITE);
    ...
    void initResultPanel() {
        ...
        resultPanel.setBackground(LIGHT_PURPLE);
